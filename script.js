const questions = [
  { question: "اقل سن للاحتراف؟", options: ["16","21","18","20"], answer:"18"},
  { question: " اخر event لقاضيه اتعمل فين؟", options: ["العلمين","استاد القاهره","مدينتي","فندق هيلتون"], answer: "العلمين"},
  { question: "النزال علي الحزام من كام جوله؟", options: ["3", " 4","5", "6"], answer:"5"},
  { question: "مين المغني الغني في قاضيه 005؟", options: ["دبل زكش","المدفعجيه","sharmoofers","تامر حسني"], answer:"دبل زكش"},
